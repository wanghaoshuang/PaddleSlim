...
class Logger(object):
    """
    Deafult logger in PaddleSlim.

    Args:
        name(str) : Logger name, default is ' PaddleSlim'
    """
    ...
    def __init__(self, name: str = None):
        ...
        Init Logger.
        """
        name = " PaddleSlim" if not name else name
    ...
    def use_terminator(self, terminator: str):
        """
        Use a special terminator to print.
        """
